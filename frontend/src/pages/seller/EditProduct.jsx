    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`/api/products/${id}`, {
                name, price, description, quantity, unit, image_url
            });
        ...
        <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem', maxWidth: '600px' }}>
            ...
            <form className="card" onSubmit={handleSubmit} style={{ marginTop: '1rem' }}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                    ...
                    <textarea value={description} onChange={e => setDescription(e.target.value)} style={{ width: '100%', padding: '0.5rem' }}></textarea>
                </div>
                <div style={{ marginBottom: '1rem' }}>
                    <label>Price</label>
                ...
                <div style={{ marginBottom: '1rem' }}>
                    ...
                    <input type="number" value={quantity} onChange={e => setQuantity(e.target.value)} style={{ width: '100%', padding: '0.5rem' }} />
                </div>
                <div style={{ marginBottom: '1rem' }}>
