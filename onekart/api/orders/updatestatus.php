...
if (!in_array($status, ['placed', 'confirmed', 'shipped', 'out for delivery', 'delivered'])) {
    echo json_encode(["status" => "error", "message" => "Invalid status. Use 'placed', 'confirmed', 'shipped', 'out for delivery', or 'delivered'"]);
    exit;
}
$jwt = new JWT();
